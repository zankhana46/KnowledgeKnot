            ...
            <div className=' '>
                ...
                <div className='relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white '>
                    ...
                    >
                        ...
                        <HighlightText text={"Knowledge Knot"} />
                    </motion.div>
                    ...
                    >
                        With our community oriented approach of online courses, you can learn at your own pace, from anywhere in the world, and get access to a wealth of resources, including hands-on projects, quizzes and personalized feedback from instructors.
                    </motion.div>
                ...
                <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between'>
                    ...
                    <div className=''>
                        <CodeBlocks
                            ...
                            subheading={
                                "Our certified courses are designed and taught by industry experts who have years of experience in their respective fields and are passionate about sharing their knowledge with you."
                            }
                            ctabtn1={
                                {
                    ...
                    <div>
                        <CodeBlocks
                            ...
                            subheading={
                                "Go ahead, give it a try. Our community oriented peer to peer skillsharing embraces a mutual learning environment."
                            }
                            ctabtn1={{
                    ...
                    <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                        {/* <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            <div className='text-3xl lg:text-4xl font-semibold w-full lg:w-[45%]'>
                                Learn the skills that you are
                                <HighlightText text={"passionate about"} />
                            </div>

                            <div className='flex flex-col gap-10 w-full lg:w-[40%] items-start'>
                                <div className='text-[16px]'>
                                    KnowledgeKnot provides a community centric apporach towards skill development and provides a wide range of learning paths. 
                                </div>
                                <CTAButton active={true} linkto={"/signup"}>
                                    <div>
                                        Learn more
